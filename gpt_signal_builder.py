...
def build_messages_classify(
    ...
    system_text = (
        ...
        "[FACTS CHECK — BẮT BUỘC]\n"
        "- Lấy EMA cuối cùng của từng TF từ JSON đầu vào. ƯU TIÊN 'snapshot.ma.ema20' và 'snapshot.ma.ema50'; nếu không có snapshot thì mới lấy từ 'rows[*].ema20/ema50' (nếu được cung cấp).\n"
        "- Nếu nêu lý do dựa trên EMA, PHẢI kèm số liệu: ví dụ '4H ema20=..., ema50=...' và kết luận đúng (ema20>ema50 => up; ema20<ema50 => down).\n"
